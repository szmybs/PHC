    ...
    for pkl_path in tqdm(all_pkls):
        ...
        for person_id in range(num_people):
            ...
            if args.on_the_ground:
                ...
                # 重新创建对齐地面的 SkeletonState (可选，如果你需要保存对齐后的 global_rotation)
                new_sk_state = SkeletonState.from_rotation_and_root_translation(
                    skeleton_tree, 
...
if __name__ == "__main__":
    # # data1 = joblib.load("sample_data/amass_isaac_standing_upright_slim.pkl")
    # # data2 = joblib.load("data/3dpw/3dpw_test_upright_whole_sequence.pkl")
    data3 = joblib.load("sample_data/phc_act/3dpw_test_upright_whole_sequence/noise_False_0.05.pkl")
    print()
